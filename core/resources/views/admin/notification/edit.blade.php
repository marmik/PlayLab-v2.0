                    ...
                    <div class="table-responsive table-responsive--sm">
                        <table class="table align-items-center table--light">
                            ...
                            @forelse($template->shortcodes as $shortcode => $key)
                                <tr>
                                    <th data-label="@lang('Short Code')"><span class="short-codes">@php echo "{{". $shortcode ."}}"  @endphp</span></th>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive table-responsive--sm">
                        <table class=" table align-items-center table--light">
                            ...
                            <tr>
                                <td data-label="@lang('Short Code')"><span class="short-codes">@{{@php echo $shortCode @endphp}}</span></td>
