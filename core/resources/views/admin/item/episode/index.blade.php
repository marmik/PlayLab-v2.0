    					...
    					<tbody>
    						...
    						<tr>
    							...
    							<td data-label="@lang('Action')">
    								...
    								@if($episode->video)
    								<a href="{{ route('admin.item.episode.updateVideo',$episode->id) }}" class="btn btn-sm btn-outline--info">
    									<i class="la la-cloud-upload-alt"></i>@lang('Update Video')
    								</a>
    								@else
    								<a href="{{ route('admin.item.episode.addVideo',$episode->id) }}" class="btn btn-sm btn-outline--warning">
