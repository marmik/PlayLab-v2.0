            ...
            <nav class="navbar navbar-expand-xl p-0 align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav main-menu mx-auto ms-xl-5">
                        ...
                        <li><a href="{{route('user.wishlist')}}">@lang('My Wishlist')</a></li>
                    ...
                    <div class="nav-right ml-auto d-flex flex-wrap gap-4">
                        ...
                        @else
                        <div class="dropdown">
                            <button type="button" class="" data-bs-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false"><i class="las la-user-plus"></i> @lang('Account')</button>
