                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control form--control" name="gateway" required>
                                    <option value="" class="payment__option">@lang('Select One')</option>
                                    @foreach($gatewayCurrency as $data)
                                    <option class="payment__option" value="{{$data->method_code}}" @selected(old('gateway') == $data->method_code) data-gateway="{{ $data }}">{{$data->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group d-none">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" name="amount" class="form-control form--control" value="{{ $subscription->plan->pricing }}" autocomplete="off" required>
                            ...
                            <div class="mt-3 preview-details d-none">
                                <ul class="list-group list-items">
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <span><span class="fw-bold">{{ showAmount($subscription->plan->pricing ) }}</span> {{__($general->cur_text)}}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between">
